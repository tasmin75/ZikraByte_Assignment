...
const Footer = () => {
  ...
  return (
    <footer className=" " style={{backgroundImage: `url(${bg})`, backgroundSize: 'cover', backgroundPosition: 'f'}}>

      <div className="container  mx-auto px-4 py-12 pt-[7rem]  text-white">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-12 h-12 bg-primary-foreground rounded-xl flex items-center justify-center">
                <img src={logo} alt="Nourished Logo" className="w-10 h-10"/>
              </div>
            </div>
